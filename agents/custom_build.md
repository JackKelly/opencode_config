...
- **Implementation Phase:** Execute the Architect's plan in `docs/temp/implementation_plan.md`.
- **Iteration Phase:** Address the specific `FLAW-XXX` items listed in the review files generated by the Scientist, Tester, and Reviewer (e.g., `docs/temp/scientist_code_review_1.md`).
